...
def inicializar_tabla_ingredientes(db_dir_path):
    ...
    ingredientes = [
        ('Soja texturizada',         0.25, 3.5, 'Beige',    0.95, 50, 30, 4.0,     24.8, 45.2,  80.4,  59.9,     25.0, 82.0,  38.5,  12.0, 45.2), # listo
        ('Harina integral de trigo', 0.6,  1,   'Marrón',    0.8, 13, 75, 1.0,     23.5, 38.9,  68.3,  22.1,     37.0, 76.0,  26.7,  12.9, 43.4), # listo FDC ID: 169721
        ('Harina de garbanzo',       0.7,  10,   'Amarillo', 0.85, 22, 58, 6.0,     27.7, 43.1,  71.6,  67.4,    26.0, 79.0,  37.5,  9.80, 42.3), # listo FDC ID: 173756
        ('Harina de Arroz',          0.5,  5,   'Blanco',   0.80, 4,  80, 1.4,     25.0, 41.0,  82.0,  35.8,     42.0, 90.0,  35.3,  12.1, 58.5), # listo FDC ID: 169714
        ('Harina de arvejas',        0.6,  2,   'Verde',    0.85, 22, 60, 2.0,     19.7, 36.00, 60.00, 58.50,    21.0, 57.0,  37.5,  6.80, 43.40), # listo FDC ID: 170419
        ('Harina de avena',          0.6,  2,   'Beige',    0.85, 13, 66, 7.0,     22.1, 38.7,  72.4,  32.1,     42.0, 80.0,  29.4,  13.8, 46.8)  # FDC ID: 172678
    ]
